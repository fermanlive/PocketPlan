...
const monthDataService = {
  ...
  async createExtraFund(monthId, fund, userId)                  { return activeService.createExtraFund(monthId, fund, userId); },
  async updateExtraFund(monthId, fundId, updates, userId)       { return activeService.updateExtraFund(monthId, fundId, updates, userId); },
  async deleteExtraFund(monthId, fundId, userId)                { return activeService.deleteExtraFund(monthId, fundId, userId); },
  async createExtraFundItem(monthId, fundId, item, userId)      { return activeService.createExtraFundItem(monthId, fundId, item, userId); },
  async updateExtraFundItem(monthId, fundId, itemId, upd, uid)  { return activeService.updateExtraFundItem(monthId, fundId, itemId, upd, uid); },
  async deleteExtraFundItem(monthId, fundId, itemId, userId)    { return activeService.deleteExtraFundItem(monthId, fundId, itemId, userId); },
